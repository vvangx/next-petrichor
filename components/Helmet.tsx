...
export default function Helmet() {
	return (
		<Head>
			<meta name="description" content="PETRICHOR Jewelry Official Website." />
			<link
			...
			<meta property="og:url" content="https://petrichor.jewelry" />
			<meta property="og:description" content="PETRICHOR Official Website." />
		</Head>
	);
}
